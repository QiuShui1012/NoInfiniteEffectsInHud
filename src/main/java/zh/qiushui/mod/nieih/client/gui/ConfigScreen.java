...
public class ConfigScreen extends Screen {
    ...
    private ContainerObjectSelectionList<ConfigScreen.Entry> list;
    ...
    protected void init() {
        super.init();
        if (this.list == null) {
            this.list = this.addWidget(ConfigList.of(
            ...
            this.list = this.addWidget(ConfigList.recreate(this.list));
        }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (this.activeTooltip != null && this.tooltipTicks >= 10) {
            guiGraphics.renderTooltip(this.font, this.activeTooltip, new MenuTooltipPositioner(this.getRectangle()), mouseX, mouseY);
        }
    }
    ...
    abstract static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        protected Entry(String nameKey) {
            ...
            this.tooltip = List.of(Component.translatable(nameKey + ".desc").getVisualOrderText());
        }
        ...
        protected CategoryEntry(String id, Entry... entries) {
            ...
            this.button = this.addChildren(Button.builder(
                ...
                button -> {
                    ...
                    screen.list = ConfigList.of(this);
    ...
    private static class BooleanEntry extends Entry {
        ...
        protected BooleanEntry(ModConfigSpec.BooleanValue config) {
